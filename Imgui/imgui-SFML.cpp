...
// Custom things
bool isButtonPressed(sf::Mouse::Button button, const ImGuiIO& io){
  return s_mousePressed[button] && !io.WantCaptureMouse;
}
bool isKeyPressed(sf::Keyboard::Key key, const ImGuiIO& io){
  return sf::Keyboard::isKeyPressed(key) && !io.WantCaptureKeyboard;
}

...
class Camera{
  public:
    ...
    m_view(m_origin, sf::Vector2f(m_widht, m_height)), m_moveBoundarySize(m_widht * 0.75f, m_height * 0.75f),
    m_moveBoundary(m_view.getCenter() - m_moveBoundarySize/2.0f, m_moveBoundarySize)
    {
      m_window.setView(m_view);
      m_maxCameraSpeed = 200.0f;
    }
  ...
  private:
    ...
    ImGuiIO& m_io;
    sf::View m_view;
    sf::Vector2f m_moveBoundarySize;
